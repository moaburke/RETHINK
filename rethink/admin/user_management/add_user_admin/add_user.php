 ...
 * Author: Moa Burke
 * Date: 2024-11-04
 * Description: Provides a form for adding new users to the system.
 * 
...
if (isset($_POST['add-user'])) {
    ...
    if (empty($error)) { 
        ...
        $query = "INSERT INTO users (FirstName, LastName, UserName, Email, Password, Role, Created, profileImg) VALUES('$firstName', '$lastName', '$username', '$email', '$password', '$role', now(), '$img')";
        $queryRun = mysqli_query($con, $query); // Execute the query
        
        // Check if the query was successful
        if ($queryRun) {
            // Set a success message for successful addition of the admin
            $_SESSION['feedbackMessage'] = "<div class='message-text success-alert'><p>ユーザーが正常に追加されました。</p></div>";
    ...
    <body>
        ...
        <div class="admin-main-wrapper">
            ...
            <div class="breadcrumbs breadcrumbs-admin">
                ...
                <p class="bread-active">Add User</p>
            </div><!-- .breadcrumbs -->

            <div class="user-management-form-wrapper">
                <div class="user-management-header">
                    <!-- Title for the user addition section in Japanese and English -->
                    <h3>
                        <span class="japanese-title">ユーザーの追加</span>
                        <span class="english-title">Add User</span>
                    </h3>
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="input-container focus select-area">
                        ...
                        <select name="role" required class="input form-control">
                            ...
                            <option value="1">Admin</option> <!-- Option for Admin role, set as default -->
                            <option value="0" selected>User</option> <!-- Option for User role -->
                        </select>
                    ...
                    <div class="form-actions">
                        ...
                        <button type="submit" name="add-user" class="primary-btn">Add User</button>
                    </div><!-- .form-actions -->
                </form>
