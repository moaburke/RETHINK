<?php
/**
 * File: edit_admin_details.php
 * Author: Moa Burke
 * Date: 2024-11-04
 * Description: Generates an HTML form for updating admin user profile information.
 * 
...
if(isset($_POST['update-user'])){
    ...
    if (empty($error)) { 
        ...
        if ($queryRun) {
            ...
            $_SESSION['feedbackMessage'] = "<div class='message-text success-alert'><p>管理者が正常に更新されました。</p></div>";
        } else {
...
<html lang="en">
    ...
    <body>
        ...
        <div class="admin-main-wrapper">
            ...
            <!-- Breadcrumb navigation for admin pages with a link back to Manage Users and an active indicator for the Edit Admin page -->
            <div class="breadcrumbs breadcrumbs-admin">
                ...
                <p class="bread-active">Edit Admin</p>
            </div><!-- .breadcrumbs -->
                ...
                if (isset($_GET['id'])) {
                    ...
                    if (mysqli_num_rows($userResult) > 0) {
                        ...
                        foreach ($userResult as $userRecord) { ?>
                            ...
                            <!-- Form wrapper for editing admin details -->
                            <div class="user-management-form-wrapper">
                                <div class="user-management-header">
                                    <h3>
                                        <!-- Display titles in Japanese and English for editing the admin -->
                                        <span class="japanese-title">管理者の編集</span>
                                        <span class="english-title">Edit Admin</span>
                                    </h3>
                                ...
                                <form action="" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="input-container 
                                        ...
                                        <input type="text" name="username" value="<?php echo $userRecord['Username'];?>" class=" input form-control" 
                                            <?php 
                                            // Check if the username is "MainAdmin" and set the field to read-only if true
                                            if ($userRecord['Username'] == "MainAdmin") 
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <button type="submit" name="update-user" class="primary-btn">Update Admin</button>
                                    </div><!-- .form-actions -->
                                </form>
